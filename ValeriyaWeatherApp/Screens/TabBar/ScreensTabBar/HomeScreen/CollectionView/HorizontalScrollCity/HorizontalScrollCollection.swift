...
final class CityHorizontalScrollCollection: UICollectionViewController, UICollectionViewDelegateFlowLayout {
	...
	override func viewDidLoad() {
		...
		collectionView.register(HorizontalScrollCityCell.self,
								forCellWithReuseIdentifier: HorizontalScrollCityCell.identifier)
	}
	...
	override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HorizontalScrollCityCell.identifier,
															for: indexPath) as? HorizontalScrollCityCell else {
